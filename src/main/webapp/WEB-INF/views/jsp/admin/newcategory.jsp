        ...
        <s:div>
            <s:div>
                <s:form action="cat" method="post">
                    ...
                    <sj:datepicker name="cat.createdDate" label="Created Date" displayFormat="dd/mm/yy" size="3"/>
                    <sj:datepicker name="cat.updatedDate" label="Updated Date" displayFormat="dd/mm/yy" size="3" />
